# Cross-repo audit — 2026-09-19 20:12 UTC

## Open pull requests

- [ ] **boostmebitch #426** — fix(live): read a Podcast Index 0 as no timestamp, not as a broadcast that ended in 1970 · opened just now by ChadFarrow
- [ ] **boostmebitch #424** — New episodes from your favorites, on main — probe-first, and one cap for both ends · opened 4 hours ago by ChadFarrow
- [ ] **boostmebitch #422** — The listen queue on main — and #414's resume position wired into its four paths · opened 4 hours ago by ChadFarrow
- [ ] **boostmebitch #421** — Downloads, re-landed on current main — and the id bug that paid the show instead of the song · opened 4 hours ago by ChadFarrow
- [ ] **stablekraft-app #266** — Hold back an adopted private item, not only an adopted private feed · opened 16 hours ago by ChadFarrow
