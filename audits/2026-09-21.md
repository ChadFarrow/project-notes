...
- [ ] **stablekraft-app #272** — Follow-up: confirm the egress drop, and the database-read leads left alone · opened 1 day ago by ChadFarrow (0 comments)
- [ ] **boostbox #32** — Follow-ups from the Railway cost work (#29, #30, #31) · opened 1 day ago by ChadFarrow (0 comments)
- [ ] **boostmebitch #388** — buddy boost iso · opened 9 days ago by ChadFarrow (0 comments)
- [ ] **MSP-2.0 #138** — when someone imports a feed check it for errors · opened 9 days ago by ChadFarrow (0 comments)
...
- [ ] **boostmebitch #371** — iOS lock screen shows no artwork for the now-playing item · opened 12 days ago by ChadFarrow (0 comments)
- [ ] **PC20-Nostr #44** — Vector 27's claim assertions encode one of the two local-state models rule 2 declares conformant · opened 13 days ago by ChadFarrow (0 comments)
- [ ] **blup #3** — Bump nostr-tools to ≥2.25.2 — socket leak on failed relay connects · opened 15 days ago by ChadFarrow (0 comments)
- [ ] **BoostBot-Starter #1** — Bump nostr-tools to ≥2.25.2 — socket leak on failed relay connects · opened 15 days ago by ChadFarrow (0 comments)
- [ ] **Helipad-to-Nostr-BoostBot #16** — Bump nostr-tools to ≥2.25.2 — socket leak on failed relay connects · opened 15 days ago by ChadFarrow (0 comments)
- [ ] **is-this-thing-on #18** — Bump nostr-tools to ≥2.25.2 — leaked WebSockets on failed relay connects · opened 15 days ago by ChadFarrow (0 comments)
- [ ] **HPM-Lightning #3** — Bump nostr-tools to ≥2.25.2 — leaked WebSockets on failed relay connects · opened 15 days ago by ChadFarrow (0 comments)
- [ ] **NMNU #2** — Bump nostr-tools to ≥2.25.2 — leaked WebSockets on failed relay connects · opened 15 days ago by ChadFarrow (0 comments)
- [ ] **TRM-Lightning #4** — Bump nostr-tools to ≥2.25.2 — leaked WebSockets on failed relay connects · opened 15 days ago by ChadFarrow (0 comments)
- [ ] **RSS-music-site-template #3** — Bump nostr-tools to ≥2.25.2 — leaked WebSockets on failed relay connects · opened 15 days ago by ChadFarrow (0 comments)
- [ ] **lnaddress-music #14** — Bump nostr-tools to ≥2.25.2 — leaked WebSockets on failed relay connects · opened 15 days ago by ChadFarrow (0 comments)
- [ ] **ITDV-Lightning #9** — Bump nostr-tools to ≥2.25.2 — leaked WebSockets on failed relay connects · opened 15 days ago by ChadFarrow (0 comments)
- [ ] **MSP-2.0-Desktop-App #66** — Bump nostr-tools to ≥2.25.2 — leaked WebSockets on failed relay connects · opened 15 days ago by ChadFarrow (0 comments)
- [ ] **MSP-2.0 #137** — Bump nostr-tools to ≥2.25.2 — leaked WebSockets on failed relay connects · opened 15 days ago by ChadFarrow (0 comments)
- [ ] **boostmebitch #304** — Spark rail will break in Firefox: flashnet sends Access-Control-Allow-Headers: * which does not cover Authorization · opened 18 days ago by ChadFarrow (1 comments)
- [ ] **boostmebitch #275** — Look for zap splits · opened 22 days ago by ChadFarrow (0 comments)
