# Cross-repo audit — 2026-09-23 03:51 UTC

## Open pull requests

- [ ] **boostbox #33** — fix(bot): cover art from Podcast Index when the sent feed has none; link v4vmusic boosts · opened 2 hours ago by ChadFarrow
- [ ] **thelounge-candr #37** — feat(public): read the WEBIRC password from the environment · opened 13 hours ago by ChadFarrow
- [ ] **thelounge-candr #36** — docs: record the 2026-09-22 bots and Lounge deploys · opened 13 hours ago by ChadFarrow
